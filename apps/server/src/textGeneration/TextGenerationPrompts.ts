...
export function buildYoloReviewPrompt(input: YoloReviewPromptInput) {
  const prompt = [
    ...
    "Rules:",
    "- Do not edit files, write files, run shell commands, or ask the user questions.",
    "- You may do read-only research when tools are available: inspect repository files, search code, search the web, and fetch relevant public pages.",
    "- Prefer provided transcript/checkpoint evidence first; use research to verify claims, current docs, external facts, or missing implementation details.",
    "- If research tools are unavailable, still complete the review from the provided transcript, latest assistant response, and checkpoint summary.",
