...
export function makeOpenCodeAdapter(
  ...
  return Effect.gen(function* () {
    ...
    const steerTurn: OpenCodeAdapterShape["steerTurn"] = Effect.fn("steerTurn")(function* (_input) {
      return yield* new ProviderAdapterRequestError({
        provider: PROVIDER,
        method: "turn/steer",
        detail: "OpenCode does not expose native turn steering.",
      });
    });
