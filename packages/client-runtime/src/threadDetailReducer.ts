...
const queuedFollowUpOrder = O.combine<OrchestrationQueuedFollowUp>(
  O.mapInput(O.String, (followUp) => followUp.queuedAt),
      ...
      return {
        ...
        thread: {
          ...
          queuedFollowUps: pipe(
            ...
            Arr.filter((followUp) => followUp.id !== event.payload.followUp.id),
            Arr.append(event.payload.followUp),
