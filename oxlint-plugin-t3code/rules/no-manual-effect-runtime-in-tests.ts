...
const LEGACY_BASELINE = new Map<string, number>([
  ...
  ["apps/server/src/orchestration/Layers/ProviderCommandReactor.test.ts", 90],
  ...
  ["apps/server/src/orchestration/Layers/YoloReactor.test.ts", 11],
  ["apps/server/src/orchestration/decider.fork.test.ts", 2],
  ["apps/server/src/orchestration/decider.scheduledJobs.test.ts", 7],
  ["apps/server/src/orchestration/decider.turnInterrupt.test.ts", 4],
  ["apps/server/src/orchestration/decider.yolo.test.ts", 5],
  ["apps/server/src/orchestration/Normalizer.test.ts", 2],
  ["apps/server/src/orchestration/projector.test.ts", 22],
  ["apps/server/src/project/Layers/ProjectSetupScriptRunner.test.ts", 4],
  ["apps/server/src/provider/acp/CursorAcpSupport.test.ts", 7],
